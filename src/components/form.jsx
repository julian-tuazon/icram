      ...
      <>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="mb-4 d-flex justify-content-center">
            <textarea id="question" className="form-control" rows="2" onChange={this.handleChange} value={this.state.question} maxLength={350} required />
          </div>
          <div>
            <label htmlFor="answer">Answer:</label>
          </div>
          <div className="mb-4 d-flex justify-content-center">
            <textarea id="answer" className="form-control" rows="2" onChange={this.handleChange} value={this.state.answer} maxLength={350} required />
          </div>
